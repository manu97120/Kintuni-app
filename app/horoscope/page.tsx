                    ...
                    <form id="form" className="max-w-lg mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="mb-4">
                                ...
                                <input className="form-input text-black" id="latitude" name="latitude" type="number" step="any" min="-90" max="90" defaultValue="" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="longitude" className="block">Longitude (decimal)</label>
                                <input className="form-input text-black" id="longitude" name="longitude" type="number" step="any" min="-180" max="180" defaultValue="" />
                            </div>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="date" className="block">Date of birth</label>
                            <input className="form-input text-black" id="date" name="date" type="date" defaultValue="" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="time" className="block">Local Time of birth</label>
                            <input className="form-input text-black" id="time" name="time" type="time" defaultValue="" />
                        </div>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            <input className="form-input text-black" id="conjunction" name="conjunction" type="number" defaultValue="" />
                            <label htmlFor="opposition" className="block">Opposition</label>
                            <input className="form-input text-black" id="opposition" name="opposition" type="number" defaultValue="" />
                            <label htmlFor="trine" className="block">Trine</label>
                            <input className="form-input text-black" id="trine" name="trine" type="number" defaultValue="" />
                            <label htmlFor="square" className="block">Square</label>
                            <input className="form-input text-black" id="square" name="square" type="number" defaultValue="" />
                            <label htmlFor="sextile" className="block">Sextile</label>
                            <input className="form-input text-black" id="sextile" name="sextile" type="number" defaultValue="" />
                            <label htmlFor="quincunx" className="block">Quincunx</label>
                            <input className="form-input text-black" id="quincunx" name="quincunx" type="number" defaultValue="" />
                            <label htmlFor="quintile" className="block">Quintile</label>
                            <input className="form-input text-black" id="quintile" name="quintile" type="number" defaultValue="" />
                            <label htmlFor="septile" className="block">Septile</label>
                            <input className="form-input text-black" id="septile" name="septile" type="number" defaultValue="" />
                            <label htmlFor="semi-square" className="block">Semi-square</label>
                            <input className="form-input text-black" id="semi-square" name="semi-square" type="number" defaultValue="" />
                            <label htmlFor="semi-sextile" className="block">Semi-sextile</label>
                            <input className="form-input text-black" id="semi-sextile" name="semi-sextile" type="number" defaultValue="" />
                        </div>
                        <div className="mb-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
